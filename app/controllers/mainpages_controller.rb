class MainpagesController < ApplicationController
  ...
  def show
    @stepones = Stepone.where(mainpage_id: @mainpage.id)
  end
  ...
  def create
    ...
    respond_to do |format|
      if @mainpage.save
        format.html { redirect_to root_path, notice: 'Mainpage was successfully created.' }
  ...
  private
    ...
    def mainpage_params
      params.require(:mainpage).permit(:mathlist)
    end
end
